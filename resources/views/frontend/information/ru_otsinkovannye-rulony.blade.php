...
<section class="container">
    ...
    <div class="wow fadeInRight">
        <h1 class="welcome-text text-center">Оцинкованные рулоны</h1>
    </div>
    <div class="padding-top"></div>
