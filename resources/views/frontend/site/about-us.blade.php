...
<section class="container">
    ...
    <div class="row">
        <div class="col-md-6" style="padding-bottom: 15px;">
            <p class="text-black-h3">GET SOME INFORMATION ABOUT OUR COMPANY</p>
            <br/>
            <p class="text-gray-16">Our company is one of the largest pipe producers in the world. It consists of 9 factories. The products of the company are well known and have a high reputation among consumers of the building complex. Our products are considered to be one of the best in the world and is used during the construction of most of the strategic industrial, infrastructural and residential projects. We work to build long-term and reliable cooperation with our customers, providing them with high-quality products and services.</p>
            <br>
...
<section class="parallax-window" data-parallax="scroll" data-image-src="/images/template/index-parallax-03.jpg">
    <div class="container" style="position: relative;">
        <div class="parallax-text-wrap">
            <span class="parallax-text fadeIn">We have rich experience in exporting</span>
        </div>
    </div>
</section>
                ...
                <div class="row green-section-block">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p class="green-section-body">
                            We work to build long-term and reliable cooperation with our customers, providing them with high-quality products and services. The satisfaction of our customers - that is the main task.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="row green-section-block">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p class="green-section-body">
                            Our products are considered to be one of the best in the world and is used during the construction of most of the strategic industrial, infrastructural and residential projects.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="row green-section-block">
                    ...
                    <div class="col-xs-9">
                        <p class="green-section-title">
                            RESPECTFUL ATTITUDE TO EACH CUSTOMER
                        </p>
                        <p class="green-section-body">
            ...
            <div class="col-md-6 col-sm-6">
                <div class="row green-section-block">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p class="green-section-body">
                            Everyone who comes in contact with us should leave with something, whether an employee, a peer, a customer - or just a a stranger in need.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <br/>
            <br/>
            <p class="text-gray-16">The company has a team of soul-mates who solve together the problems of providing consumers with heat and pure water. Many employees are working from the the founding of the company. We annually held training and retraining of personnel. Workers are provided with all necessary conditions for implementation of tasks as part of their activities.</p>
            <br/>
