...
<section class="content container">
    <div class="box box-warning">
        ...
        <div class="box-body">
            ...
            <form id="form-add-product" role="form" method="POST" action="{{ url('administration/products/add') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
                        ...
                        <div class="form-group{{ $errors->has('images.0') ? ' has-error' : '' }}">
                            <label for="images" class="control-label">Фотографии</label>
